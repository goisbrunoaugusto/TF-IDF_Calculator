...
@Fork(value = 1, jvmArgsAppend = {"-Xms2G", "-Xmx4G"}) // Configurações da JVM para o fork do benchmark
...
public class TfIdfBenchmark {
    ...
    @Benchmark
    public void benchmarkFullProcess(Blackhole bh) throws IOException {
        List<Map<String, Double>> result = TfIdfCalculator.main(filePath);
        bh.consume(result);
    }
}